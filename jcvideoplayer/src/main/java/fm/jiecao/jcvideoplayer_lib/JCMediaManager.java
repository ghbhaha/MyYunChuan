            ...
            switch (msg.what) {
                ...
                case HANDLER_RELEASE:
                    ...
                    if (httpProxyCacheServer != null) {
                        httpProxyCacheServer.unregisterCacheListener(JCMediaManager.this);
                    }
                    mediaPlayer.release();
                    break;
            }
            ...
            public void run() {
                if (JCVideoPlayerManager.getCurrentJcvd() != null) {
                    if (percent > buffterPoint) {
                        ...
                        JCVideoPlayerManager.getCurrentJcvd().setBufferProgress(buffterPoint);
                    }
                }
            }
        });
